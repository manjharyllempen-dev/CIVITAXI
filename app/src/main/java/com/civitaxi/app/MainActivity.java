    ...
    web.setWebViewClient(new WebViewClient() {
      ...
      @Override public void onPageFinished(WebView view, String url) {
        ...
        if (url != null && url.startsWith("file:///android_asset/")) {
          view.evaluateJavascript("(function(){if(document.getElementById('civi-patches-loader'))return;var s=document.createElement('script');s.id='civi-patches-loader';s.src='civi-patches.js?v=6';document.body.appendChild(s);})();", null);
        }
      }
    });
