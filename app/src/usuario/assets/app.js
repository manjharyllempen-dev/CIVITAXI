...
function installPassengerManualRouteShell(){
  ...
  if(hint)hint.textContent='Origen y destino son manuales. Escribe calle, número, distrito, provincia y departamento; CiviTaxi los registrará en la solicitud.';
}
function installPassengerManualRouteLogic(){
  ...
  const statusCopy={
    aceptado:{title:'CiviTaxi · Viaje aceptado',body:'Tu chofer aceptó la solicitud de viaje.'},
    chofer_en_camino:{title:'CiviTaxi · Chofer en camino',body:'Tu chofer ya va camino a la dirección de origen.'},
    chofer_llego:{title:'CiviTaxi · Chofer llegó',body:'Tu chofer llegó al origen. Ya puedes salir a encontrarlo.'},
    en_viaje:{title:'CiviTaxi · Viaje iniciado',body:'El chofer inició tu viaje hacia el destino.'},
    completado:{title:'CiviTaxi · Llegaste al destino',body:'Tu viaje llegó al destino y fue finalizado.'}
  };
